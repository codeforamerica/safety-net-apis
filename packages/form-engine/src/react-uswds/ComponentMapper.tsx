...
// Values MUST match the Zod schema enums generated by the pipeline.
const ENUM_OPTIONS: Record<string, { value: string; label: string }[]> = {
  ...
  citizenshipStatus: [
    ...
    { value: 'cuban_haitian_entrant', label: 'Cuban/Haitian Entrant' },
    { value: 'cofa_citizen', label: 'COFA Citizen' },
    { value: 'conditional_entrant', label: 'Conditional Entrant' },
    { value: 'paroled_for_one_year', label: 'Paroled for One Year+' },
    { value: 'battered_spouse_child', label: 'Battered Spouse/Child' },
    { value: 'trafficking_victim', label: 'Trafficking Victim' },
    { value: 'other_qualified', label: 'Other Qualified' },
  ...
  relationshipToApplicant: [
    ...
    { value: 'unrelated_adult', label: 'Unrelated Adult' },
    { value: 'unrelated_child', label: 'Unrelated Child' },
  ],
  livingArrangement: [
  ...
  noticeDeliveryPreference: [
    ...
    { value: 'electronic_portal', label: 'Electronic Portal' },
