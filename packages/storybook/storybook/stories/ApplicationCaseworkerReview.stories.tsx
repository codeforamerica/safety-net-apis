// Auto-generated from authored/contracts/application/caseworker-review.form.yaml. Run `npm run generate:stories` to regenerate.
...
// Layout
import contract from '../../authored/contracts/application/caseworker-review.form.yaml';
import layoutYaml from '../../authored/contracts/application/caseworker-review.form.yaml?raw';
// Test data
import fixtures from '../../authored/fixtures/application-caseworker-review.yaml';
import fixturesYaml from '../../authored/fixtures/application-caseworker-review.yaml?raw';
// Permissions
...
function StoryWrapper() {
  ...
  const tabs: EditorTab[] = [
    { id: 'layout', label: 'Layout', filename: 'authored/contracts/application/caseworker-review.form.yaml', source: layoutYaml },
    { id: 'test-data', label: 'Test Data', filename: 'authored/fixtures/application-caseworker-review.yaml', source: fixturesYaml },
