// Auto-generated from authored/contracts/application/california-caseworker-review.form.yaml. Run `npm run generate:stories` to regenerate.
...
import { applicationUpdateSchema } from '../../generated/schemas/application-california';
import type { FormContract, PermissionsPolicy } from '../../src/engine/types';

// Layout
import contract from '../../authored/contracts/application/california-caseworker-review.form.yaml';
import layoutYaml from '../../authored/contracts/application/california-caseworker-review.form.yaml?raw';
// Test data
import fixtures from '../../authored/fixtures/application-california-caseworker-review.yaml';
import fixturesYaml from '../../authored/fixtures/application-california-caseworker-review.yaml?raw';
// Permissions
...
const meta: Meta = {
  title: 'Forms/California Application Review',
...
function StoryWrapper() {
  ...
  const tabs: EditorTab[] = [
    { id: 'layout', label: 'Layout', filename: 'authored/contracts/application/california-caseworker-review.form.yaml', source: layoutYaml },
    { id: 'test-data', label: 'Test Data', filename: 'authored/fixtures/application-california-caseworker-review.yaml', source: fixturesYaml },
  ...
  return (
    <ContractPreview
      tabs={tabs}
      contractId="application-california-caseworker-review"
      formTitle="California Application Review"
...
export const ApplicationCaliforniaCaseworkerReview: StoryObj = {
  name: 'California Application Review',
  render: () => <StoryWrapper />,
};
