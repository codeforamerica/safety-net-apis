// Auto-generated from contracts/application/california-caseworker-review.form.yaml. Run `npm run generate:stories` to regenerate.
...
// Layout
import contract from '../contracts/application/california-caseworker-review.form.yaml';
import layoutYaml from '../contracts/application/california-caseworker-review.form.yaml?raw';
// Test data
import fixtures from '../fixtures/application-california-caseworker-review.yaml';
import fixturesYaml from '../fixtures/application-california-caseworker-review.yaml?raw';
// Permissions
...
function StoryWrapper() {
  ...
  const tabs: EditorTab[] = [
    { id: 'layout', label: 'Layout', filename: 'contracts/application/california-caseworker-review.form.yaml', source: layoutYaml },
    { id: 'test-data', label: 'Test Data', filename: 'fixtures/application-california-caseworker-review.yaml', source: fixturesYaml },
